...
echo 'Exynos Modem 5400 configuration'
...
AT+GOOGSETNV="!NRRRC.NUM_SUPPORTED_NR_BAND_LIST",0,"1B,00"\r
' > /dev/umts_router & cat /dev/umts_router

# HPUE
echo 'Enable HPUE for LTE Bands 38/41, NR Bands n38/n40/n41/n77/n78 Power Class 2, and n41/n77/n78 Power Class 1.5'
echo '
